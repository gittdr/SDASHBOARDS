...
namespace CARGAR_EXCEL.Models
{
...

    {
        ...
        public DataTable RyDiciembre2022()
        {
            ...
            using (SqlConnection connection = new SqlConnection(cadena2))
            {
                using (SqlCommand selectCommand = new SqlCommand("SELECT orden, segmento, billto, fechaTimbrado FROM Reporte_Timbradas WHERE fechaTimbrado is not null AND MONTH(try_CONVERT(DATETIME, fechaTimbrado)) = 12 AND YEAR(try_CONVERT(DATETIME, fechaTimbrado)) = '2022' GROUP BY orden, segmento, billto, fechaTimbrado ORDER BY fechaTimbrado DESC", connection))
                {
                    selectCommand.CommandType = CommandType.Text;
                    selectCommand.CommandTimeout = 100000;
                    using (SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(selectCommand))
        ...
        public DataTable RyEnero2023()
        {
            ...
            using (SqlConnection connection = new SqlConnection(cadena2))
            {
                using (SqlCommand selectCommand = new SqlCommand("SELECT orden, segmento, billto, fechaTimbrado FROM Reporte_Timbradas WHERE fechaTimbrado is not null AND MONTH(try_CONVERT(DATETIME, fechaTimbrado)) = 01 AND YEAR(try_CONVERT(DATETIME, fechaTimbrado)) = '2023' GROUP BY orden, segmento, billto, fechaTimbrado ORDER BY fechaTimbrado DESC", connection))
                {
                    selectCommand.CommandType = CommandType.Text;
                    selectCommand.CommandTimeout = 100000;
                    using (SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(selectCommand))
        ...
        public DataTable RyDiciembrePenafiel2022()
        {
            ...
            using (SqlConnection connection = new SqlConnection(cadena2))
            {
                using (SqlCommand selectCommand = new SqlCommand("SELECT orden, segmento, billto, fechaTimbrado FROM RtPenafiel WHERE fechaTimbrado is not null AND MONTH(try_CONVERT(DATETIME, fechaTimbrado)) = 12 AND YEAR(try_CONVERT(DATETIME, fechaTimbrado)) = '2022' GROUP BY orden, segmento, billto, fechaTimbrado ORDER BY fechaTimbrado DESC", connection))
                {
                    selectCommand.CommandType = CommandType.Text;
                    selectCommand.CommandTimeout = 100000;
                    using (SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(selectCommand))
        ...
        public DataTable RyEneroPenafiel2023()
        {
            ...
            using (SqlConnection connection = new SqlConnection(cadena2))
            {
                using (SqlCommand selectCommand = new SqlCommand("SELECT orden, segmento, billto, fechaTimbrado FROM RtPenafiel WHERE fechaTimbrado is not null AND MONTH(try_CONVERT(DATETIME, fechaTimbrado)) = 01 AND YEAR(try_CONVERT(DATETIME, fechaTimbrado)) = '2023' GROUP BY orden, segmento, billto, fechaTimbrado ORDER BY fechaTimbrado DESC", connection))
                {
                    selectCommand.CommandType = CommandType.Text;
                    selectCommand.CommandTimeout = 100000;
                    using (SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(selectCommand))
        ...
        public DataTable RyDiciembrePalacioH2022()
        {
            ...
            using (SqlConnection connection = new SqlConnection(cadena2))
            {
                using (SqlCommand selectCommand = new SqlCommand("SELECT orden, segmento, billto, fechaTimbrado FROM RtPlacioH WHERE fechaTimbrado is not null AND MONTH(try_CONVERT(DATETIME, fechaTimbrado)) = 12 AND YEAR(try_CONVERT(DATETIME, fechaTimbrado)) = '2022' GROUP BY orden, segmento, billto, fechaTimbrado ORDER BY fechaTimbrado DESC", connection))
                {
                    selectCommand.CommandType = CommandType.Text;
                    selectCommand.CommandTimeout = 100000;
                    using (SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(selectCommand))
        ...
        public DataTable RyEneroPalacioH2023()
        {
            ...
            using (SqlConnection connection = new SqlConnection(cadena2))
            {
                using (SqlCommand selectCommand = new SqlCommand("SELECT orden, segmento, billto, fechaTimbrado FROM RtPlacioH WHERE fechaTimbrado is not null AND MONTH(try_CONVERT(DATETIME, fechaTimbrado)) = 01 AND YEAR(try_CONVERT(DATETIME, fechaTimbrado)) = '2023' GROUP BY orden, segmento, billto, fechaTimbrado ORDER BY fechaTimbrado DESC", connection))
                {
                    selectCommand.CommandType = CommandType.Text;
                    selectCommand.CommandTimeout = 100000;
                    using (SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(selectCommand))
        ...
        public DataTable RyDiciembreDhl2022()
        {
            ...
            using (SqlConnection connection = new SqlConnection(cadena2))
            {
                using (SqlCommand selectCommand = new SqlCommand("SELECT orden, segmento, billto, fechaTimbrado FROM RtDhl WHERE fechaTimbrado is not null AND MONTH(try_CONVERT(DATETIME, fechaTimbrado)) = 12 AND YEAR(try_CONVERT(DATETIME, fechaTimbrado)) = '2022' GROUP BY orden, segmento, billto, fechaTimbrado ORDER BY fechaTimbrado DESC", connection))
                {
                    selectCommand.CommandType = CommandType.Text;
                    selectCommand.CommandTimeout = 100000;
                    using (SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(selectCommand))
        ...
        public DataTable RyEneroDhl2023()
        {
            ...
            using (SqlConnection connection = new SqlConnection(cadena2))
            {
                using (SqlCommand selectCommand = new SqlCommand("SELECT orden, segmento, billto, fechaTimbrado FROM RtDhl WHERE fechaTimbrado is not null AND MONTH(try_CONVERT(DATETIME, fechaTimbrado)) = 01 AND YEAR(try_CONVERT(DATETIME, fechaTimbrado)) = '2023' GROUP BY orden, segmento, billto, fechaTimbrado ORDER BY fechaTimbrado DESC", connection))
                {
                    selectCommand.CommandType = CommandType.Text;
                    selectCommand.CommandTimeout = 100000;
                    using (SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(selectCommand))
        ...
        public DataTable TotalProcOct2022(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Oct_2022_JC", connection))
                {

                    selectCommand.CommandType = CommandType.StoredProcedure;
                    selectCommand.CommandTimeout = 100000;
                    selectCommand.Parameters.AddWithValue("@nfecha", (object)nfecha);
                    selectCommand.ExecuteNonQuery();
                    using (SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(selectCommand))
                    {
                        try
        ...
        public DataTable TotalProcOctubre2022(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Octubre_2022_JC", connection))
                {
        ...
        public DataTable TotalProcNoviembre2022(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Noviembre_2022_JC", connection))
                {
        ...
        public DataTable TotalProcDiciembre()
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Diciembre_JC", connection))
                {
        ...
        public DataTable TotalProcEnero()
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Enero_JC", connection))
                {
        ...
        public DataTable TotalProcDiciembre2022(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Diciembre_2022_JC", connection))
                {
        ...
        public DataTable TotalProcEnero2023(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Enero_2023_JC", connection))
                {
        ...
        public DataTable TotalProcAgoPenafielyear(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Ago_Penafiel_year_JC", connection))
                {
        ...
        public DataTable TotalProcOctubrePenafielyear(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Octubre_Penafiel_year_JC", connection))
                {
        ...
        public DataTable TotalProcNoviembrePenafielyear(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Noviembre_Penafiel_year_JC", connection))
                {
        ...
        public DataTable TotalProcDiciembrePenafiel()
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Diciembre_Penafiel_JC", connection))
                {
        ...
        public DataTable TotalProcEneroPenafiel2023()
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Enero_Penafiel_2023_JC", connection))
                {
        ...
        public DataTable TotalProcDiciembrePenafielyear(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Diciembre_Penafiel_year_JC", connection))
                {
        ...
        public DataTable TotalProcEneroPenafielyear2023(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Enero_Penafiel_year_2023_JC", connection))
                {
        ...
        public DataTable TotalProcOctubrePalacioHyear(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Octubre_PalacioH_year_JC", connection))
                {
        ...
        public DataTable TotalProcDiciembrePalacioH()
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Diciembre_PalacioH_JC", connection))
                {
        ...
        public DataTable TotalProcEneroPalacioH2023()
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Enero_PalacioH_2023_JC", connection))
                {
        ...
        public DataTable TotalProcNoviembrePalacioHyear(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Noviembre_PalacioH_year_JC", connection))
                {
        ...
        public DataTable TotalProcDiciembrePalacioHyear(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Diciembre_PalacioH_year_JC", connection))
                {
        ...
        public DataTable TotalProcEneroPalacioHyear2023(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Enero_PalacioH_year_2023_JC", connection))
                {
        ...
        public DataTable TotalProcOctubreDhlyear(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Octubre_Dhl_year_JC", connection))
                {
        ...
        public DataTable TotalProcDiciembreDhl()
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Diciembre_Dhl_JC", connection))
                {
        ...
        public DataTable TotalProcEneroDhl2023()
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Enero_Dhl_2023_JC", connection))
                {
        ...
        public DataTable TotalProcNoviembreDhlyear(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Noviembre_Dhl_year_JC", connection))
                {
        ...
        public DataTable TotalProcDiciembreDhlyear(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Diciembre_Dhl_year_JC", connection))
                {
        ...
        public DataTable TotalProcEneroDhlyear2023(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Enero_Dhl_year_2023_JC", connection))
                {
        ...
        public DataTable TotalProcAgoPalacioHyear(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Ago_PalacioH_year_JC", connection))
                {
        ...
        public DataTable TotalProcAgoDhlyear(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Ago_Dhl_year_JC", connection))
                {
        ...
        public DataTable TotalProcSep2022(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Sep_2022_JC", connection))
                {
        ...
        public DataTable TotalProcSepPenafielyear(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Sep_Penafiel_year_JC", connection))
                {
        ...
        public DataTable TotalProcSepPalacioHyear(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Sep_PalacioH_year_JC", connection))
                {
        ...
        public DataTable TotalProcSepDhlyear(string nfecha)
        {
            ...
            {
                connection.Open();
                using (SqlCommand selectCommand = new SqlCommand("sp_Total_Order_Sep_Dhl_year_JC", connection))
                {
